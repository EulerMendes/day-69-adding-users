...
class BlogPost(db.Model, UserMixin, Base):
    ...
    comments_on_blog = relationship("Comment", back_populates="blogspot")
...
class Comment(db.Model, UserMixin, Base):
    ...
    blogspot_id = db.Column(Integer, ForeignKey("blog_posts.id"))
    blogspot = relationship("BlogPost", back_populates="comments_on_blog")
